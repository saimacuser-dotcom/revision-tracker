...
const BASE = (() => {
  ...
  const deployed = "https://revision-tracker-c4fr.onrender.com/api"; // Replace with your deployed backend URL
  return window.location.hostname.includes("localhost") ? local : deployed;
})();
